...
/**
 * PYU drawer layout - extends Boost with hero section for dashboard/frontpage.
 *
 * @package   theme_pyu
...
// PYU hero section for dashboard, frontpage, mycourses.
$showhero = in_array($PAGE->pagelayout, ['mydashboard', 'frontpage', 'mycourses'], true);
$heroheading = $showhero ? get_config('theme_pyu', 'heroheading') : '';
$herosubheading = $showhero ? get_config('theme_pyu', 'herosubheading') : '';
if (empty($heroheading)) {
    $heroheading = 'Trường Đại học Phú Yên';
}
...
echo $OUTPUT->render_from_template('theme_pyu/drawers', $templatecontext);
